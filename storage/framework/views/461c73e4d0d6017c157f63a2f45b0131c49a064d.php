...
endif; ?>" name="name" value="<?php echo e(old('name')); ?>" placeholder="Nombre Completo" required autocomplete="name" autofocus>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" placeholder="Correo">
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" required autocomplete="new-password" placeholder="Contraseña">
