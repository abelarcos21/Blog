...
<div class="wrapper">
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo e(asset('adminlte/img/user3-128x128.jpg')); ?>" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo e(asset('adminlte/img/user4-128x128.jpg')); ?>" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>Desde - <?php echo e(auth()->user()->created_at->format('d/y/m')); ?></small>
                </p>
              </li>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo e(route('configuracion')); ?>" class="btn btn-info btn-block">Perfil</a>
                </div>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <?php echo $__env->make('autor.partials.nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </section>
    <!-- /.sidebar -->
  </aside>
...
<?php echo $__env->make('autor.posts.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</body>
</html>
...
<?php /**PATH C:\laragon\www\Blog\resources\views/autor/layout.blade.php ENDPATH**/ ?>