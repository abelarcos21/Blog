<?php $__env->startSection('header'); ?>
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
        <li><a href="<?php echo e(route('admin.dashboard')); ?>"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li><a href="<?php echo e(route('admin.posts.index')); ?>"><i class="fa fa-list"></i> Posts</a></li>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Blog\resources\views/admin/posts/edit.blade.php ENDPATH**/ ?>