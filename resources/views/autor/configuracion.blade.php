    ...
    <section class="content">
        ...
        <!-- /.col -->
            ...
            <div class="tab-content">
                ...
                <form action="{{ route('autor.perfil.update')}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                    @csrf @method('PUT')
                ...
                <div class=" tab-pane" id="cambiarpassword">
                    <form action="{{ route('autor.password.update') }}" method="POST" class="form-horizontal">
                        @csrf  @method('PUT')
                        <div class="form-group">
