...
@section('header')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
        <li><a href="{{ route('autor.dashboard')}}"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li><a href="{{-- route('autor.posts.index') --}}"><i class="fa fa-list"></i> Posts</a></li>
...
@section('content')
    ...
    <form action="{{ route('autor.posts.update', $post)}}" method="POST" enctype="multipart/form-data">
        @csrf @method('PUT')
        <div class="col-md-8">
