            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>Desde - {{ auth()->user()->created_at->format('d/y/m') }}</small>
                </p>
              </li>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="{{ route('configuracion')}}" class="btn btn-info btn-block">Perfil</a>
                </div>
