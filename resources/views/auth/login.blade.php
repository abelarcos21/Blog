...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form method="POST" action="{{ route('login') }}">
      ...
      <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="Correo" required autocomplete="email" autofocus>
    ...
    {{-- <div class="social-auth-links text-center">
      ...
      <a href="#" class="btn btn-block btn-social btn-github btn-flat"><i class="fa fa-github"></i> Github</a>
